...
def tabuada():
   ...
   while escolha >= 1 or escolha <= 5:
      ...
      if escolha < 1 or escolha > 4:       
         print('\nErro, o número deve ser entre 1 a 4 \nTente novamente')
         time.sleep(2)
         tabuada()
         continue    	    
      else:
   ...
   if escolha == 1:
      for i in range (1, 11):
         print('         {:.0f} + {} = {:.0f}'.format(oper_num, i, oper_num + i))
   if escolha == 2:
      for i in range (1, 9):
         print('         {:.0f} - {} = {:.0f}'.format(oper_num, i, oper_num - i))
      for i in range (9, 11):
         print('         {:.0f} - {} = {:.0f}'.format(oper_num, i, i - oper_num))
   if escolha == 3:
      for i in range (1, 11):
         print('         {:.0f} X {} = {:.0f}'.format(oper_num, i, oper_num * i))
   if escolha == 4:
      for i in range (1, 11):
